###########################################################
# RD53A signals      convert from hirose-san pin assingn 3 data 1 eudet
#                    RX_CHANNELS in board pkg is 3
###########################################################
#la31_p (DPA0_p)
#la31_n (DPA0_n)
...
#la02_p (DPD0_p)
#la02_n (DPD0_n)
set_property PACKAGE_PIN AF20 [get_ports {eudet_clk}]
set_property PACKAGE_PIN AF21 [get_ports {eudet_clk}]
#la08_p (DPD1_p)                                      
#la08_n (DPD1_n)                                      
...
#la03_p (DPD2_p)                                      
#la03_n (DPD2_n)                                      
set_property PACKAGE_PIN AG20 [get_ports {eudet_trig}}]
set_property PACKAGE_PIN AH20 [get_ports {eudet_trig}}]
#la00_cc_p (DPD3_p)
#la00_cc_n (DPD3_n)
