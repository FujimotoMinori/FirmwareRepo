...
#
# Generated by export_simulation on Sun Oct 14 04:23:48 JST 2018
#
################################################################################
...
switch to the './rx_channel_fifo.sh' script.

./rx_channel_fifo.sh -reset_run
...
./rx_channel_fifo.sh -noclean_files

For more information on the script, please type './rx_channel_fifo.sh -help'.
