...
HD_PWD='/home/atlasj/work/XpressK7_RD53A/YARR_ocha/debug/Yarr-fw/syn/kc705/bram_rd53a_quad_ohio/yarr/project_1/project_1.runs/ila_axis_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_axis.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_axis.tcl
