...
HD_PWD='/home/atlasj/work/XpressK7_RD53A/YARR_ocha/debug/Yarr-fw/syn/kc705/bram_rd53a_quad_ohio/yarr/project_1/project_1.runs/rx_bridge_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_bridge_fifo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rx_bridge_fifo.tcl
