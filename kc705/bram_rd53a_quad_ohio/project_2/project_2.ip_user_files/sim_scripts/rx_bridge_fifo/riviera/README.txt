...
#
# Generated by export_simulation on Sun Oct 14 18:13:38 JST 2018
#
################################################################################
...
switch to the './rx_bridge_fifo.sh' script.

./rx_bridge_fifo.sh -reset_run
...
./rx_bridge_fifo.sh -noclean_files

For more information on the script, please type './rx_bridge_fifo.sh -help'.
