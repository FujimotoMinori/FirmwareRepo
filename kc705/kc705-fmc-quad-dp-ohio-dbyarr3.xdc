...
# one data in portD  ext_trg in portB eudet in portA  RX^CHANNELS in board package is 1
# poat A for eudet and port D for data
#Fixed polarity
#la25_p
#la25_n
...
#la32_n
#la32_p
set_property PACKAGE_PIN Y30 [get_ports {eudet_busy_p}]
set_property PACKAGE_PIN AA30 [get_ports {eudet_busy_n}]
#la30_n
#la30_p
set_property PACKAGE_PIN AB29 [get_ports {eudet_trig_p}]
set_property PACKAGE_PIN AB30 [get_ports {eudet_trig_n}]
#la28_n
#la28_p
set_property PACKAGE_PIN AE30 [get_ports {eudet_rst_p}]
set_property PACKAGE_PIN AF30 [get_ports {eudet_rst_n}]
#la26_n
#la26_p
...
#la00_cc_n
#la00_cc_p
set_property PACKAGE_PIN AD23 [get_ports {fe_data_p[3]}]
set_property PACKAGE_PIN AE24 [get_ports {fe_data_n[3]}]
#la01_cc_n
#la01_cc_p
...
#la33_n
#la33_p
set_property PACKAGE_PIN AH21 [get_ports {fe_cmd_p[0]}]
set_property PACKAGE_PIN AJ21 [get_ports {fe_cmd_n[0]}]
#la05_n
#la05_p
...
#la31_n
#la31_p
set_property PACKAGE_PIN AD29 [get_ports {eudet_clk_p}]
set_property PACKAGE_PIN AE29 [get_ports {eudet_clk_n}]
#la27_n
#la27_p
...
#la08_n
#la08_p
set_property PACKAGE_PIN AJ22 [get_ports {fe_data_p[1]}]
set_property PACKAGE_PIN AJ23 [get_ports {fe_data_n[1]}]
#la09_n
#la09_p
